...
def match(A, B, grupo, neutrality, amistoso, knockOut = False):
    if not lightSpeed:
        print("\n========================================================================================================================\n")
    ...
    if not knockOut and not amistoso:
        showTable(grupo)
    if not gameMode:
        ...
        for i in range(19):
            ...
            for j in range(10):
                ...
                if jogosCasa[x] <= jogosCasa[teamAway]:
                    if turno:
                        match(times[teamAway], times[x], grupo, False, False)
                    else:
                        match(times[x], times[teamAway], grupo, False, False)
                    jogosCasa[x] += 1
                else:
                    if turno:
                        match(times[x], times[teamAway], grupo, False, False)
            ...
            while True:
                ...
                while True:
                    ...
                    if neutro == '1':
                        ...
                        print("Valor invalido! Tente novamente...")
                match(time1, time2, times, neutro, True)
